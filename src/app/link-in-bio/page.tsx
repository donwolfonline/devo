    ...
    <div className="min-h-screen">
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        ...
        >
          ...
          <Link 
            href="/templates"
            className="inline-flex items-center px-8 py-3 rounded-full border border-purple-600 text-white hover:bg-purple-600/10 transition-colors text-lg"
          >
        ...
        >
          {templates.map((template) => (
            <motion.div
              ...
              className="group relative bg-white/5 rounded-2xl overflow-hidden hover:bg-white/10 transition-colors"
            >
              ...
              <div className="p-6">
                ...
                <div className="mt-6">
                  <span className="inline-block px-3 py-1 text-sm bg-purple-600/20 text-purple-400 rounded-full">
                    {template.category}
                  </span>
                </div>
              </div>
