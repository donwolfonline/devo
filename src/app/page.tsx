          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 sm:mb-20">
            <a 
              ...
              className="group relative inline-flex items-center justify-center px-8 py-4 rounded-xl
                       text-white bg-gradient-to-r from-purple-950/90 via-purple-900 to-purple-950/90
                       transition-all duration-300 transform hover:scale-105 overflow-hidden
                       shadow-[0_0_20px_rgba(88,28,135,0.4)] hover:shadow-[0_0_35px_rgba(147,51,234,0.6)]
                       border border-purple-800/20"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-purple-950/50 via-purple-800/50 to-purple-950/50 
                            opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl" />
